...
function Tabbed({ content }) {
	...
	return (
		<div>
			<div className="tabs">
				<Tab num={0} key="0" activeTab={activeTab} onClick={setActiveTab} />
				<Tab num={1} key="1" activeTab={activeTab} onClick={setActiveTab} />
				<Tab num={2} key="2" activeTab={activeTab} onClick={setActiveTab} />
		...
		<div className="tab-content">
			...
			<div className="tab-actions">
				...
				<div className="hearts-counter">
					...
					<button onClick={tripleInk}>+++</button>
				</div>
			</div>
